...
class ProxyOnCancelListener(listener: DialogInterface.OnCancelListener?) :
...
class ProxyOnDismissListener(listener: DialogInterface.OnDismissListener?) :
...
class ProxyOnShowListener(listener: DialogInterface.OnShowListener?) :
