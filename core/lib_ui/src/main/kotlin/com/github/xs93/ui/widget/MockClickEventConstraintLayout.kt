...
class MockClickEventConstraintLayout @JvmOverloads constructor(
    ...
    init {
        ...
        context.withStyledAttributes(attrs, R.styleable.MockClickEventConstraintLayout) {
            excludeIds =
                getString(R.styleable.MockClickEventConstraintLayout_exclude_child_view_ids)
        }
    }
