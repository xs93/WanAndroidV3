...
import com.github.xs93.wan.common.AppConstant
import com.github.xs93.wan.common.entity.User
import com.github.xs93.wan.common.entity.UserDetailInfo
import com.github.xs93.wan.common.store.AccountStore
...
class AccountDataManager @Inject constructor() {
    ...
    init {
        AppInject.mainScope.launch(Dispatchers.IO) {
            val uri = AppConstant.BASE_URL.toUri()
